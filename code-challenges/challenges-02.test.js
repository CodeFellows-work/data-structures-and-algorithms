...
const raisedToTheThird = (arr) => {
  // Solution code here...
  arr.forEach((item) => {
    poweredArr.push(Math.pow(item, 3));
  });
  return poweredArr;
};
...
const forEachTwoToThe = (arr) => {
  ...
  arr.forEach((item) => {
    // if(item > 0){
    twoToTheFor.push(Math.pow(2, item));
    // } else{
    //   twoToTheFor.push(Math.pow(2, item));
    // }
  });
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  const mappedTwo = arr.map(result => {
...
const charCode = (arr) => {
  // Solution code here...
  const toChar = arr.map(charred => {
    return String.charCode(charred);
  });
  return toChar;
};
...
const evenOdd = (arr) => {
  // Solution code here...
  const compare = arr.map(compared => {
    if(compared % 2 === 0){
      return 'even';
    }else{
      return 'odd';
